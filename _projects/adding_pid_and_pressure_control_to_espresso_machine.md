...
<div class="row">
  <div class="col-sm mt-3 mt-md-0">
    {% include figure.liquid path="assets/img/adding_pid_pressure/2 BEGINNIG.jpeg" title="Base machine — DeLonghi ECP 35.31" class="img-fluid rounded z-depth-1" %}
  </div>
</div>
<div class="caption">Start: the DeLonghi ECP 35.31 used as the project platform.</div>
