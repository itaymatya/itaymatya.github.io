...
img: assets/img/bambu mouse print/thumbnail.jpg
importance: 2
---

# Bambu Mouse Print Project
...
<p>The completed mouse is tested and operated, confirming all functions work as intended.</p>

<div class="caption">
  Each step shows the process from printing to a fully functional custom mouse.
</div>
